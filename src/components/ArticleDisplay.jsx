        ...
        return (
            <div>
                ...
                >
                    ...
                    <Modal.Footer>
                        <Button onClick={this.changeModalState} href={"/issues/" + this.props.year + "/" + this.props.id}>
                            Open Page
                        </Button>
                    </Modal.Footer>
                </Modal>
                <Card imgSrc={this.props.image}>
                    ...
                    <button onClick={this.changeModalState} class="inline-flex items-center py-2 px-3 text-sm font-medium text-center text-white bg-maroon-100 rounded-lg hover:bg-white hover:text-maroon-100 focus:ring-4 focus:outline-none focus:ring-ghostly-black dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">
                        Read more
